...
This folder contains runnable, interview-focused coding exercises. Each exercise is self-contained: the question is kept directly in the source file, followed by the implementation, examples or tests, and an explanation where appropriate.
...
1. Open the runnable source file and read the question block directly above the implementation.
...
5. Run the included sample tests.
