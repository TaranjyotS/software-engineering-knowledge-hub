...
|                                 Topic                                 |                File                 |                                        Focus                                        |
| --------------------------------------------------------------------- | ----------------------------------- | ----------------------------------------------------------------------------------- |
| Professional Profile and Interview Positioning                        | `my_profile.md`                     | Generic professional profile, positioning, evidence inventory, and privacy guidance |
| Behavioral and Technical Interview Playbook                           | `interview_questions.md`            | Company-neutral behavioral answers, STAR examples, and interview strategy           |
| Backend, Data, and AI Project Deep-Dive Guide                         | `project_deep_dive.md`              | Backend, data, AI, delivery, and production-scenario answer bank                    |
...
| Software Design Patterns for Python and Backend Interviews            | `software_design_patterns.md`       | GoF and backend patterns, Python examples, LLD selection, comparisons, trade-offs   |
